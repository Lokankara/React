...
export const CreateCourse = ({ authorsList, onAddAuthor, onSaveCourse, onCancel }) => {
  ...
  return (
    <section className='create-course-wrapper'>
      ...
      <div className='description-box'>
        <label className='description-label'>{LABEL_TEXTS.DESCRIPTION}</label>
        <textarea
        ...
        <div className='panel-left-column'>
          ...
          <div className='sub-section-box'>
            ...
            <p className='duration-preview'>
              Duration: <span className='duration-time'>{pipeDuration(duration)}</span>
            </p>
          </div>
        </div>
